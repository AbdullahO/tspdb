...
CREATE or REPLACE FUNCTION create_pindex (table_name text, time_column text, value_column text[], index_name text, normalize boolean DEFAULT true,auto_update boolean DEFAULT true, timescale boolean DEFAULT false, t_var int DEFAULT -1 ,k int DEFAULT Null , k_var int DEFAULT 1, "T" int DEFAULT 2500000, "T0" int DEFAULT 1000,var_direct boolean DEFAULT true,gamma numeric DEFAULT 0.5, col_to_row_ratio int DEFAULT 10, agg_interval numeric DEFAULT NULL, "L" int DEFAULT 0 )
RETURNS void AS $$
